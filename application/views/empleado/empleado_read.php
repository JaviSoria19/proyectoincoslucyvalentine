                ...
                <div class="x_panel"><!-- Inicio Div x_panel -->
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <input type="hidden" name="idempleado" value="<?php echo $row->idEmpleado;?>">
                            <button class="btn btn-outline-danger" data-toggle="tooltip"  onclick="return confirm_modalDeshabilitar(<?php echo $row->idEmpleado; ?>)"  data-placement="top" title="Deshabilitar">
