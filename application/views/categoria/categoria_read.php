    ...
    <div class="container md-3"><!-- Inicio Div container md-3 -->
        <div class="row"><!-- Inicio Div row -->
            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><i class="fa fa-list"></i> Lista de categorias deshabilitadas.</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </li>
                            <li class="dropdown">
                    ...
                    <div class="x_content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive"><!-- Inicio Div card-box table-responsive -->
                                    <p class="text-muted font-13 m-b-30">
                                        Estimado administrador, las categorías que usted está viendo a continuación no serán visibles al momento de realizar una compra o venta.
                                    </p>
            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    <?php
                        foreach ($categoriadeshabilitados->result() as $rowdeshabilitados)
                        {
                    ?>
                    <tr>
                    <td><?php echo $rowdeshabilitados->nombreCategoria; ?></td>
                    ...
                    <td class="text-center">
                            <?php echo form_open_multipart('categoria/habilitarbd');?>
                                <input type="hidden"
                                name="idcategoria" 
                                value="<?php echo $rowdeshabilitados->idCategoria;?>">
