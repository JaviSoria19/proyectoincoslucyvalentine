<div class="right_col" role="main"><!-- Inicio Div Right Col Role Main -->
    ...
    <div class="col-md-12 bg-dark rounded text-light">
        ...
        <p><?php echo retornarSaludoPerGenero($this->session->userdata('sexo'),1); ?>, con el objetido de proteger su identidad no se mostrará su foto de perfil en la caja de comentarios, recuerde que aquí prevalece la convivencia sana y el respeto mutuo. </p>
