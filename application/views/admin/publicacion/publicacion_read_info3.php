        ...
        <div class="row"><!-- Inicio Div row -->
            <div class="col-md-12 col-sm-12 "><!-- Inicio Div col-md-12 col-sm-12  -->
                <div class="x_panel"><!-- Inicio Div x_panel -->
                    <div class="x_title">
                        <h2><i class="fa fa-info-circle"></i> Promoción de Actitudes Igualitarias.</h2>
                        <div class="clearfix">
                        </div>
                    </div>
                    <div class="x_content"><!-- Inicio Div x_content -->
                        ...
                        <?php echo form_open_multipart('publicacion/indexPromociondeActitudesIgualitarias_filtro');?>
                    ...
                    <div class="alert alert-warning text-light">
                        <h2 class="font-weight-bold">
                            <i class="fa fa-inbox"></i> Vaya, al parecer no hay promoción de actitudes igualitarias. dentro del rango de búsqueda.</h2>
                    </div>
                    <?php endif ?>
                    <?php
