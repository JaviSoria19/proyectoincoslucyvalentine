...
class Categoria extends CI_Controller {
	...
	public function index()
	{
        ...
        if($this->session->userdata('tipo')=='admin')
        {
            ...
            $listadeshabilitados=$this->categoria_model->listacategoriasdeshabilitados();
    ...
    public function agregar()
	{
        ...
        $this->load->view('inc/sidebargentelella');
        $this->load->view('inc/topbargentelella');
        $this->load->view('categoria/categoria_insert',);
        $this->load->view('inc/creditosgentelella');
        $this->load->view('inc/footergentelella');
	}
    ...
    public function agregarbd()
    {
        ...
        if($this->form_validation->run()==FALSE)
        {
            ...
            $this->categoria_model->agregarcategorias($data);
        ...
        public function eliminarbd()
    {
        ...
        $this->categoria_model->eliminarcategorias($idcategoria);
        redirect('categoria/index','refresh');
    ...
    {
        $idcategoria=$_POST['idcategoria'];
        $data['infocategoria']=$this->categoria_model->recuperarcategorias($idcategoria);
        $this->load->view('inc/headergentelella');
        $this->load->view('inc/sidebargentelella');
        $this->load->view('inc/topbargentelella');
        $this->load->view('categoria/categoria_update',$data);
        $this->load->view('inc/creditosgentelella');
        $this->load->view('inc/footergentelella');
    }
        ...
        public function modificarbd()
    {
        ...
        else
        {
            ...
            $this->categoria_model->modificarcategorias($idcategoria,$data);
            redirect('categoria/index','refresh');
        }
    }
    ...
    public function guest()
    {
        ...
        $this->load->view('inc/sidebargentelella');
        $this->load->view('inc/topbargentelella');
        $this->load->view('categoria/producto_guest',$data);
        $this->load->view('inc/creditosgentelella');
        $this->load->view('inc/footergentelella');        
    }
